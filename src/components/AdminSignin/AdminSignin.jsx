...
const AdminSignin = () => {
  ...
  useEffect(() => {
    dispatch(
      setDefaultModeColor({ modeColor: "default", theme: currentTheme })
    );
  }, [currentTheme]);
  ...
  useEffect(() => {
    ...
    if (googleAdminLoginKioskdata?.foundUser?.role === "Admin") {
      localStorage.setItem(
        "adminkiyosktoken",
        googleAdminLoginKioskdata?.token
      );
      localStorage.setItem("adminkiyoskloggin", "true");
      dispatch(setAdminToken(googleAdminLoginKioskdata));
      localStorage.setItem("salonSelect", "false");
      ...
      localStorage.setItem(
        "ConnectedSalonId",
        googleAdminLoginKioskdata?.foundUser?.salonId
      );
      dispatch(setAdminToken(googleAdminLoginKioskdata));
      localStorage.setItem("salonSelect", "false");
      navigate("/selectsalon");
    ...
    googleAdminLoginKioskisSuccess,
    googleAdminLoginKioskdata,
    googleAdminLoginKioskisError,
    navigate,
  ]);
